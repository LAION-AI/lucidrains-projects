...
| [nucleotide-transformer](https://github.com/lucidrains/nucleotide-transformer) | 3rd April, 2023 | 🧬 Nucleotide Transformer: Building and Evaluating Robust Foundation Models for Human Genomics ||
...
| [lion-pytorch](https://github.com/lucidrains/lion-pytorch) | 15th February, 2023 | 🦁 Lion, new optimizer discovered by Google Brain using genetic algorithms that is purportedly better than Adam(w), in Pytorch ||
...
| [flamingo-pytorch](https://github.com/lucidrains/flamingo-pytorch) | 28th April, 2022 | Implementation of 🦩 Flamingo, state-of-the-art few-shot visual question answering attention net out of Deepmind, in Pytorch ||
| [einops-exts](https://github.com/lucidrains/einops-exts) | 9th April, 2022 | Implementation of some personal helper functions for Einops, my most favorite tensor manipulation library ❤️ ||
...
| [memory-efficient-attention-pytorch](https://github.com/lucidrains/memory-efficient-attention-pytorch) | 3rd March, 2022 | Implementation of a memory efficient multi-head attention as proposed in the paper, "Self-attention Does Not Need O(n²) Memory" ||
...
| [anymal-belief-state-encoder-decoder-pytorch](https://github.com/lucidrains/anymal-belief-state-encoder-decoder-pytorch) | 26th January, 2022 | Implementation of the Belief State Encoder / Decoder in the new breakthrough robotics paper from ETH Zürich ||
...
| [tf-bind-transformer](https://github.com/lucidrains/tf-bind-transformer) | 8th December, 2021 | A repository with exploration into using transformers to predict DNA ↔ transcription factor binding ||
...
| [nuwa-pytorch](https://github.com/lucidrains/nuwa-pytorch) | 28th November, 2021 | Implementation of NÜWA, state of the art attention network for text to video synthesis, in Pytorch ||
...
| [halonet-pytorch](https://github.com/lucidrains/halonet-pytorch) | 24th March, 2021 | Implementation of the 😇 Attention layer from the paper, Scaling Local Self-Attention For Parameter Efficient Visual Backbones ||
...
| [nystrom-attention](https://github.com/lucidrains/nystrom-attention) | 11th February, 2021 | Implementation of Nyström Self-attention, from the paper Nyströmformer ||
...
| [pi-GAN-pytorch](https://github.com/lucidrains/pi-GAN-pytorch) | 4th December, 2020 | Implementation of π-GAN, for 3d-aware image synthesis, in Pytorch ||
...
| [nlp](https://github.com/lucidrains/nlp) | 16th June, 2020 | 🤗 nlp: datasets and evaluation metrics for Natural Language Processing in NumPy, Pandas, PyTorch and TensorFlow ||
